...
- Diretório final: `./dev-docs/tasks/prd-[nome-funcionalidade]/` (nome em kebab-case)
...
- Use o template `./dev-docs/templates/prd-template.md`
...
- Crie o diretório: `./dev-docs/tasks/prd-[nome-funcionalidade]/`
- Salve o PRD em: `./dev-docs/tasks/prd-[nome-funcionalidade]/prd.md`
...
- [ ] Arquivo salvo em `./dev-docs/tasks/prd-[nome-funcionalidade]/prd.md`
