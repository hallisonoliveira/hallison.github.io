...
- Documento de saída: `dev-docs/tasks/prd-[nome-funcionalidade]/techspec.md`

## Pré-requisitos

- Revisar padrões do projeto em @.claude/rules
- Confirmar que o PRD existe em `dev-docs/tasks/prd-[nome-funcionalidade]/prd.md`
...
- Salvar como: `dev-docs/tasks/prd-[nome-funcionalidade]/techspec.md`
...
- [ ] Arquivo escrito em `./dev-docs/tasks/prd-[nome-funcionalidade]/techspec.md`
