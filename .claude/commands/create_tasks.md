...
- PRD requerido: `dev-docs/tasks/prd-[nome-funcionalidade]/prd.md`
- Tech Spec requerido: `dev-docs/tasks/prd-[nome-funcionalidade]/techspec.md`
...
- Pasta da funcionalidade: `./dev-docs/tasks/prd-[nome-funcionalidade]/`
- Template para a lista de tarefas: `./dev-docs/templates/tasks-template.md`
- Lista de tarefas: `./dev-docs/tasks/prd-[nome-funcionalidade]/tasks.md`
- Template para cada tarefa individual: `./dev-docs/templates/task-template.md`
- Tarefas individuais: `./dev-docs/tasks/prd-[nome-funcionalidade]/[num]_task.md`

### Formato do Resumo de Tarefas (tasks.md)

- **SEGUIR ESTRITAMENTE O TEMPLATE EM `./dev-docs/templates/tasks-template.md`**

### Formato de Tarefa Individual ([num]_task.md)

- **SEGUIR ESTRITAMENTE O TEMPLATE EM `./dev-docs/templates/task-template.md`**
